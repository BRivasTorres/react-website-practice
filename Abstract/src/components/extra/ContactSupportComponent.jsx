...
const ContactSupportComponent = () => {
	return (
		<div className="text-[#191A1B] text-[1.4rem] font-medium">
			<h2 className="bg-[#FFE496] rounded-[15px] px-[1.5rem] py-[1rem] flex items-center gap-x-[2rem] font-semibold text-[1.5rem]">
			...
			<h2 className="mt-[2em]">
				Unable to sign in?
				<a className="ml-[.5rem] underline hover:cursor-pointer hover:opacity-[.6] transition-all duration-500 ease-linear ">
					Reach us here.
				</a>
			</h2>
			<section className="mt-[3rem] ">
				<h3 className="text-[2.2rem] ">Contact Support</h3>
				<ol className="list-decimal ml-[5rem] flex flex-col gap-y-[1rem] ">
					<li className="mb-[2rem] ">
						...
						/>{" "}
						Support icon.
						<ol className="list-[circle] ml-[3rem] mt-[1.6rem]">
							<li>
