...
const ContactSupportComponent = () => {
	return (
		<div className="text-[#191A1B] text-[1.4rem]">
			<h2 className="bg-[#FFE496] rounded-[15px] px-[1.5rem] py-[1rem] flex items-center gap-x-[2rem] text-[1.5rem]">
			...
			<h2 className="mt-[2em]">
				Unable to sign in?
				<a className="ml-[.5rem] extra-links-styles">Reach us here.</a>
			</h2>
			<section className="mt-[3rem] ">
				<h3 className="text-[2.2rem] font-medium ">Contact Support</h3>
